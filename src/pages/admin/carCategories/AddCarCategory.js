...
class AddCarCategory extends FormComponent {
    ...
    submit() {
        ...
        addCarCategory(this.state.data).then(response => {

            if(!response.ok) {
                this.props.onFinish(null);
                this.props.enqueueSnackbar(strings.addCarCategory.errorAdding, { variant: 'error' });
                return;
            }

            this.props.enqueueSnackbar(strings.addCarCategory.added, { variant: 'success' });
            this.props.onFinish(null);
        ...
        return (
            <Grid id='page' item md={ 12 }>
                ...
                <div className='header'>
                    <h1>{ strings.addCarCategory.pageTitle }</h1>
                </div>
